...
SECRET_KEY = 'django-insecure-p+9m9q+@)e_xi@oll69n$_tza#*rq6j=z57okqdsjts^e0foc('
...
WSGI_APPLICATION = 'Moplay.wsgi.application'
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "به موپلی خوش آمدید",

    # Copyright on the footer
    "copyright": "کلیه حقوق مادی و معنوی این وبسایت متعلق به موپلی میباشد",
    ...
    "topmenu_links": [
        ...
        {"name": "پشتیبانی", "url": "https://t.me/arvin_maroufi", "new_window": True},

        # the url of the home page of the site
        {"name": "وبسایت", "url": "http://127.0.0.1:8000/", "new_window": True},
